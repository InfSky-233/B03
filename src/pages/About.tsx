...
export default function About() {
  ...
  const secondRow = [...techStack, ...techStack];
        ...
        <section className="about__content">
          ...
          <div className="about__section">
            ...
            <div className="about__tech-wrapper">
              <div className="about__tech-scroll-container">
                <div className="about__tech-scroll about__tech-scroll--forward">
              ...
              <div className="about__tech-scroll-container">
                <div className="about__tech-scroll about__tech-scroll--reverse">
          ...
          <div className="about__section">
            ...
            <div className="about__contact">
              <a href="mailto:hello@example.com" className="about__contact-link">
              ...
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="about__contact-link">
